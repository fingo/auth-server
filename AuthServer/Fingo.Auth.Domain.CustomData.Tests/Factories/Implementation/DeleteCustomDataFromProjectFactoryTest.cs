...
namespace Fingo.Auth.Domain.CustomData.Tests.Factories.Implementation
{
    public class DeleteCustomDataFromProjectFactoryTest
    {
        [Fact]
        public void
            DeleteCustomDataFromProjectFactory_Should_Return_Instance_Of_DeleteCustomDataFromProject_Given_By_IDeleteCustomDataFromProject
            ()
        {
            //Arrange
            ...
            IDeleteCustomDataFromProjectFactory target = new DeleteCustomDataFromProjectFactory(projectMock.Object ,
                eventBusMock.Object);
