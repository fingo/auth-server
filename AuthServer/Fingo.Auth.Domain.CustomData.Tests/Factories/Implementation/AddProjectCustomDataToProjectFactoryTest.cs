...
namespace Fingo.Auth.Domain.CustomData.Tests.Factories.Implementation
{
    public class AddProjectCustomDataToProjectFactoryTest
    {
        [Fact]
        public void
            AddProjectCustomDataToProjectFactory_Should_Return_Instance_Of_AddProjectCustomDataToProject_Given_By_IAddProjectCustomDataToProject
            ()
        {
            //Arrange

            var eventBusMock = new Mock<IEventBus>();
            var customDataJsonConverterMock = new Mock<ICustomDataJsonConvertService>();
            var projectMock = new Mock<IProjectRepository>();

            //Act

            IAddProjectCustomDataToProjectFactory target = new AddProjectCustomDataToProjectFactory(
                projectMock.Object , customDataJsonConverterMock.Object , eventBusMock.Object);
