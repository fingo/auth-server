...
namespace Fingo.Auth.Domain.CustomData.Tests.Factories.Actions.Implementation
{
    public class GetCustomDataConfigurationOrDefaultForProjectTest
    {
        ...
        public void Cannot_Get_CustomDataConfiguration_From_Non_Existing_Project()
        {
            ...
            var target = new GetCustomDataConfigurationOrDefaultForProject(projectRepositoryMock.Object, customDataJsonConvertServiceMock.Object);
        ...
        [Fact]
        public void Cannot_Get_CustomDataConfiguration_From_Project_When_configurationName_Is_Not_NullOrEmpty_And_Project_Dont_Have_Custom_Data()
        {
            // Arrange
        ...
        [Fact]
        public void Cannot_Get_CustomDataConfiguration_From_Project_When_configurationName_Is_Not_NullOrEmpty_And_jsonConvertService_Throw_exception()
        {
            // Arrange
            ...
            var ex = Assert.Throws<Exception>(() => target.Invoke(1, "projectConfigurationName", ConfigurationType.Boolean));
            Assert.True(ex.Message.Contains("There was a problem with deserializing policy configurations of project with id:"));
        }
        ...
        public void Can_Get_BooleanCustomDataConfiguration_From_Project_When_configurationName_Is_Not_NullOrEmpty()
        {
            ...
            Mock<ICustomDataJsonConvertService> customDataJsonConvertServiceMock = new Mock<ICustomDataJsonConvertService>();
            customDataJsonConvertServiceMock.Setup(
                m => m.DeserializeProject(ConfigurationType.Boolean, "projectSerializedConfigurationName")).Returns(new BooleanProjectConfiguration()
                {
                    Default = true
                });
        ...
        public void Can_Get_NumberCustomDataConfiguration_From_Project_When_configurationName_Is_Not_NullOrEmpty()
        {
            ...
            Mock<ICustomDataJsonConvertService> customDataJsonConvertServiceMock = new Mock<ICustomDataJsonConvertService>();
            customDataJsonConvertServiceMock.Setup(
                m => m.DeserializeProject(ConfigurationType.Number, "projectSerializedConfigurationName")).Returns(new NumberProjectConfiguration()
                {
                    Default = 5,
                    LowerBound = 0,
                    UpperBound = 10
