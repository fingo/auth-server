...
namespace Fingo.Auth.Domain.CustomData.Tests.Factories.Actions.Implementation
{
    public class GetUserCustomDataConfigurationViewTest
    {
        ...
        public void Cannot_Get_Custom_Data_Configuration_View_From_Non_Existing_Project()
        {
            ...
            Mock<IUserCustomDataRepository> userCustomDataRepositoryMock = new Mock<IUserCustomDataRepository>();
            ...
            var target = new GetUserCustomDataConfigurationView(projectRepositoryMock.Object, customDataJsonConvertServiceMock.Object, userCustomDataRepositoryMock.Object);

            // Assert

            var ex = Assert.Throws<ArgumentNullException>(() => target.Invoke(1, 1,ConfigurationType.Boolean,"test"));
        ...
        public void Can_Get_Boolean_Custom_Configuration_View()
        {
            ...
            Mock<IUserCustomDataRepository> userCustomDataRepositoryMock = new Mock<IUserCustomDataRepository>();
            userCustomDataRepositoryMock.Setup(
                m => m.GetUserCustomData(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<string>())).Returns(new UserCustomData()
            {
        ...
        public void Can_Get_Number_Custom_Configuration_View()
        {
            ...
            ProjectCustomData projectCustomDataMock = new ProjectCustomData()
            {
