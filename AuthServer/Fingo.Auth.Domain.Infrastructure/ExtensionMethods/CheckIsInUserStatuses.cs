...
namespace Fingo.Auth.Domain.Infrastructure.ExtensionMethods
{
    public static class CheckIsInUserStatuses
    {
        ...
        public static IEnumerable<T> WithStatuses<T>(this IEnumerable<T> modelList, params UserStatus[] list) where T : BaseEntityWithUserStatus
        {
            if(list.Length == 0)
                return modelList;
        ...
        public static IEnumerable<T> WithoutStatuses<T>(this IEnumerable<T> modelList , params UserStatus[] list) where T : BaseEntityWithUserStatus
        {
            if(list.Length == 0)
                return modelList;
