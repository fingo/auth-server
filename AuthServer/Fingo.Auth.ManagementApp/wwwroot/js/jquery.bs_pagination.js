...
(function($) {
    ...
    var methods = {
        ...
        init: function(options) {
            ...
            return this.each(function() {
                ...
                if (!settings.directURL) {
                    ...
                    elem.off('click', selector_nav_top)
                        .on('click',
                            selector_nav_top,
                            function() {
                    ...
                    elem.off('click', selector_nav_prev)
                        .on('click',
                            selector_nav_prev,
                            function() {
                    ...
                    elem.off('click', selector_nav_next)
                        .on('click',
                            selector_nav_next,
                            function() {
                    ...
                    elem.off('click', selector_nav_last)
                        .on('click',
                            selector_nav_last,
                            function() {
                                var previous_selection = settings.currentPage;
                    ...
                    elem.off('click', selector_nav_pages)
                        .on('click',
                            selector_nav_pages,
                            function(event) {
                                var previous_selection = settings.currentPage;
                ...
                if (settings.showGoToPage) {
                    ...
                    elem.off('keypress', selector_go_to_page)
                        .on('keypress',
                            selector_go_to_page,
                            function(event) {
                                if (event.which === 13) {
                                    ...
                                    if (!(event.which === 8 ||
                                        event.which === 0 ||
                                        (event.shiftKey === false && (event.which > 47 && event.which < 58)))) {
                ...
                if (settings.showRowsPerPage) {
                    ...
                    elem.off('keypress', selector_rows_per_page)
                        .on('keypress',
                            selector_rows_per_page,
                            function(event) {
                                if (event.which === 13) {
        ...
        setRowsInfo: function(info_html) {
            var elem = this,
                rows_info_id = create_id(methods.getOption.call(elem, 'getOption', 'nav_rows_info_id_prefix'),
                    elem.attr('id'));
     ...
     */
    var change_page = function(container_id,
        previous_selection,
        current_selection,
        update_nav_items,
        trigger_change_page) {
