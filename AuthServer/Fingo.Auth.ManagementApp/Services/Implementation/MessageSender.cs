...
namespace Fingo.Auth.ManagementApp.Services.Implementation
{
    public class MessageSender : IMessageSender
    {
        ...
        public MimeMessage CreateMessage(string clientName, string clientEmail, string senderName, string senderEmail, string messageSubject, TextPart emailContent)
        {
