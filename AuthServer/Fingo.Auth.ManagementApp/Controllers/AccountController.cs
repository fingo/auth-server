...
namespace Fingo.Auth.ManagementApp.Controllers
{
    ...
    {
        private readonly IActivateByActivationTokenFactory _activateByActivationTokenFactory;
        private readonly IGetUserByActivationTokenFactory _getUserByActivationTokenFactory;
        private readonly IGetUserByLoginFactory _getUserByLoginFactory;
        private readonly ILogger<AccountController> _logger;
        private readonly IMessageSender _messageSender;
        private readonly IRemoteAccountService _remoteAccountService;
        ...
        public IActionResult AddUser(UserModel user)
        {
            ...
            var currentUser = _getUserByLoginFactory.Create().Invoke(user.Login);
