...
namespace Fingo.Auth.AuthServer.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public string CreateNewUserInProject(string activationToken , string login , string password , string firstName ,
            string lastName ,
            Guid projectGuid)
        {
            if (lastName == null)
            ...
            _logger.Log(LogLevel.Information ,
                $"api/account/createnewuserinproject called with activationToken={activationToken}," +
